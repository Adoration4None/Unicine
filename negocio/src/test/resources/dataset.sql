...
INSERT INTO funcion VALUES
                    --  id,   tipo,      horario,     pelicula,           sala
                        (1, "FUNCION_3D",    2,     "One Piece Film: Red",  2),
                        (2, "FUNCION_2D",    8,     "Taxi Driver",          4),
                        (3, "FUNCION_XD",    6,     "Fast and Furious 10",  3),
                        (4, "FUNCION_3D",    7,     "The Truman Show",      5),
                        (5, "FUNCION_XD",    1,     "The Batman",           1),
                        (6, "FUNCION_3D",    6,     "Lilo Lilo Cocodrilo",  2),
                        (7, "FUNCION_XD",    8,     "Fast and Furious 10",  5);
